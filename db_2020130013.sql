...
CREATE TABLE `pet` (
  ...
  `pet_happy` int NOT NULL,
  `pet_hunger` int NOT NULL,
  `pet_carry` float NOT NULL,
  PRIMARY KEY (`pet_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pet` VALUES (1,1,'assdf','as',50,0,122);
...
CREATE TABLE `player` (
  ...
  `max_item_weight` float NOT NULL,
  `equiped_pet` int DEFAULT NULL,
